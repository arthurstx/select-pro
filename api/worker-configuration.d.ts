/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: a798214cb53a1a5efaaa6e508319455c)
...
interface __BaseEnv_CloudflareBindings {
	...
	SUPABASE_URL: "https://PREENCHER-staging.supabase.co" | "https://PREENCHER.supabase.co";
	FRONT_ORIGIN: "https://PREENCHER-staging.vercel.app,http://localhost:3000" | "https://PREENCHER.vercel.app";
	RESEND_FROM_EMAIL: "onboarding@resend.dev" | "acesso@PREENCHER.com.br";
	// Secrets (`wrangler secret put`). `wrangler types` só os declara quando
	// existe um `.dev.vars` local, então eles são mantidos à mão aqui — do
	// contrário uma regeneração da tipagem apagaria `c.env.JWT_SECRET` & cia.
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		SUPABASE_URL: "https://PREENCHER-staging.supabase.co";
		FRONT_ORIGIN: "https://PREENCHER-staging.vercel.app,http://localhost:3000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOCS_USER" | "MAINTENANCE_MODE" | "GOOGLE_SHEET_ID" | "SUPABASE_URL" | "FRONT_ORIGIN" | "RESEND_FROM_EMAIL">> {}
}
