/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 746216ea9c166d028f845f08df54b769)
// Runtime types generated with workerd@1.20260730.1 2026-07-31 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PENDING_REGISTRATIONS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	OTC_EXPIRY_MINUTES: "15";
	OTC_MAX_ATTEMPTS: "5";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OTC_EXPIRY_MINUTES" | "OTC_MAX_ATTEMPTS" | "RESEND_FROM_EMAIL" | "RESEND_API_KEY">> {}
}
