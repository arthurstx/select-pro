...
- [ ] T001 Criar migration `api/migrations/0015-candidate-evaluation.sql`: dropar `metrics`
...
- [ ] T002 [P] Criar `shared/src/schemas/evaluation.schema.ts`: `EvaluationCriterionSchema`
...
- [ ] T003 [P] Exportar `evaluation.schema` em `shared/src/index.ts`.
...
- [ ] T004 Criar `api/src/core/errors/evaluation-errors.ts`: `NotInAnyGroupError`,
...
- [ ] T005 Criar `api/src/repositories/evaluation.repository.ts`: `findByEvaluatorAndCandidate`,
...
- [ ] T006 [P] Criar `api/src/services/evaluation-verdict.ts`: função pura
...
- [ ] T007 [P] `api/test/evaluation-verdict.test.ts`: testes unitários de `computeVerdict` —
      0 avaliações, 1 verde, 2 verdes, 1 vermelha isolada, 1 vermelha entre várias verdes,
      3 avaliações sem vermelha.
- [ ] T008 Criar `api/src/services/evaluation.service.ts`: `submit(userId, candidateId, ...)`
...
- [ ] T009 Criar `api/src/routes/evaluation.routes.ts`: as 4 rotas de
...
- [ ] T010 Registrar `app.route("/evaluations", evaluationRouter)` em `api/src/index.ts` **e**
...
- [ ] T011 [P] [US1] `api/test/evaluation.service.test.ts`: `submit`/`myGroup` com D1 real
...
- [ ] T012 [P] [US1] `api/test/evaluation.routes.test.ts`: `GET /evaluations/my-group` e
...
- [ ] T019 [P] [US2] `api/test/evaluation.service.test.ts` (T011 revisitado): `adminList`/
...
- [ ] T020 [P] [US2] `api/test/evaluation.routes.test.ts` (T012 revisitado):
