...
/** Busca + chips de status — mesma barra em desktop e mobile (o mockup só muda o entorno, não este bloco). */
export function FiltersBar({ searchInput, onSearchInputChange, status, onStatusChange, disabled }: FiltersBarProps) {
  return (
