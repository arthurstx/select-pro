      ...
      <div className="flex min-h-screen w-full flex-col">
        ...
        <footer className="border-border w-full border-t bg-white">
          <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-2 px-4 py-4 text-sm sm:flex-row">
            <span className="text-muted-foreground">CIMATEC Jr © 2025 — Processo Seletivo</span>
            <a href="#" className="text-muted-foreground hover:text-foreground underline-offset-4 hover:underline">
